    ...
    <ScrollView style={style.container}>
      ...
      <View style={style.body}>
        ...
        <View style={style.bodyButton}>
          ...
          >
            <Text style={style.bodyText}>Registrar-se</Text>
          </TouchableOpacity>
    ...
    <ScrollView>
      <View style={style.scroll}>
        ...
        <View style={style.bodyButton}>
          ...
          <TouchableOpacity style={style.bodyButton1} onPress={()=>console.log('Cadastro')/*props.navigation.navigate("Register")/}>
            <Text style={style.bodyText}>Registrar-se</Text>
          </TouchableOpacity>

          <TouchableOpacity style={style.bodyButton2} onPress={() => console.log('Eu enviei algo')}>
            <Text style={style.bodyText}>Login</Text>
            <ArrowRight size="25" fill='#F7BB26'/>
          </TouchableOpacity>
