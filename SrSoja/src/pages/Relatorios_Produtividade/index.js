...
const Area = (props) => {
  ...
  const callMiniMap =()=>{
     setMiniMapSelected({latitude,longitude})
  }
  

  const [miniMapSelected,setMiniMapSelected]=useState({}) 
*/

  const [data, setData] = useState({});
// console.log(resultPrevisao)
  const coordMiniMap = () => {
    setData({
      latitude: -23.17868346804205,
      longitude: -45.788685120642185,
    });
  };
          ...
          <View style={stylesArea.bodyResults}>
            ...
            <View style={stylesArea.bodyResultsRow}>
              <View style={stylesArea.bodyResultsColumn}>
                <Text style={stylesArea.bodyResultsTextPrimary}>
                  Total Coletado
                </Text>
                <Text style={stylesArea.bodyResultsTextPrimary}>Kg/Ha:</Text>
                <View style={stylesArea.bodyRowSelect}>
                  <Text style={stylesArea.bodyResultsTextSecondary}>{}</Text>
                </View>
              </View>
              <View style={stylesArea.bodyResultsColumn}>
                <Text style={stylesArea.bodyResultsTextPrimary}>
...
const Previsao = (props) => {
  ...
  const [mediaGrao,setMediaGrao] = useState({});
  
  const resultPrevisao = () =>{
    setTotalColetado({ total: '425'})
  }
  console.log('teste',props)
    ...
    <SafeAreaView style={stylesPrevisao.container}>
      <ScrollView>
        <View style={stylesPrevisao.body}>
          <Text style={stylesPrevisao.bodyTitle}>
            Insira as informações do Talhão
          </Text>
          <View style={stylesPrevisao.bodyBox}>
            <View style={stylesPrevisao.bodyRow}>
              ...
              <TextInput
                style={stylesPrevisao.bodyInput}
                placeholder="000"
                keyboardType="numeric"
                onChangeText={(value) => setQuantidadeLinha(value)}
                value={quantidadeLinha}
              />
              <Text style={stylesPrevisao.bodyTitleSecondary}>
              ...
              <TextInput
                ...
                placeholder="0.00"
                keyboardType="numeric"
                onChangeText={(value) => setDistanciaLinha(value)}
                value={distanciaLinha}
              />
            </View>
          </View>
          ...
          <View style={stylesPrevisao.bodyBox}>
            <View style={stylesPrevisao.bodyRow}>
              <Text style={stylesPrevisao.bodyTitlePrimary}>
                Intervalos na Linha
              </Text>
              <Text style={stylesPrevisao.bodyTitleSecondary}>Quantidade:</Text>
              <TextInput
                ...
                placeholder="000"
                keyboardType="numeric"
                onChangeText={(value) => setQuantidadeIntervalos(value)}
                value={quantidadeIntervalos}
              />
              <Text style={stylesPrevisao.bodyTitleSecondary}>
                Distância entre intervalos (m):
              </Text>
              <TextInput
                style={stylesPrevisao.bodyInput}
                placeholder="0.00"
                keyboardType="numeric"
                onChangeText={(value) => setDistanciaIntervalos(value)}
                value={distanciaIntervalos}
              />
              <Text style={stylesPrevisao.bodyTitleSecondary}>
                Plantas por Intervalo:
              </Text>
              <TextInput
                style={stylesPrevisao.bodyInput}
                placeholder="000"
                keyboardType="numeric"
                onChangeText={(value) => setPlantasIntervalos(value)}
                value={plantasIntervalos}
              />
            </View>
          </View>
          ...
          <View style={stylesPrevisao.bodyBox}>
            <View style={stylesPrevisao.bodyRow}>
              ...
              <TextInput
                ...
                placeholder="000"
                keyboardType="numeric"
                onChangeText={(value) => setQuantidadeGraos(value)}
                value={quantidadeGraos}
              />
              <Text style={stylesPrevisao.bodyTitleSecondary}>
              ...
              <TextInput
                ...
                placeholder="0.00"
                keyboardType="numeric"
                onChangeText={(value) => setDistanciaPlantas(value)}
    ...
    <SafeAreaView style={stylesCalculo.container}>
      <ScrollView>
        <View style={stylesCalculo.body}>
          <Text style={stylesCalculo.bodyTitle}>
            Insira as Coletas realizadas
          </Text>
          <View style={stylesCalculo.bodyBox}>
            <View style={stylesCalculo.bodyRow}>
              ...
              <TextInput
                style={stylesCalculo.bodyInput}
                placeholder="000"
                keyboardType="numeric"
                onChangeText={(value) => setColeta(value)}
                value={coleta}
              />
      ...
      <View style={stylesCalculo.footer}>
        ...
        <View style={stylesCalculo.footerRow}>
          ...
          <View style={stylesCalculo.footerColumn}>
            <Text style={stylesCalculo.footerTextPrimary}>
              Média por Coleta
            </Text>
            <Text style={stylesCalculo.footerTextPrimary}>Kg/Ha:</Text>
            <Text style={stylesCalculo.footerTextSecondary}>0</Text>
